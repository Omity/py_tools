...
; this file is for github workflow only
...
[Files]
Source: "{#MySrcPath}\dist\py_tools\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#MySrcPath}\dist\py_tools\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
